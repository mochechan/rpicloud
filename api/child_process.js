/* child_process
("exec", {command: "", options: {}, callback: function(){}});
("spawn", {command: "", control: "", args: [], options: {}, stdout_on_data: function(){}, stderr_on_data: function(){}, on_close: function(){}});
*/
...
module.exports = {
	exec: function exec () {
		...
		child_process.exec(args.command, args.options || {}, args.callback || function callback (err, stdout, stderr) {
			log('No given callback');
			log('stdout: ' + stdout);
			log('stderr: ' + stderr);
    	if (err !== null) {
      	log('exec error: ' + err);
